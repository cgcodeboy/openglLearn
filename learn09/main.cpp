...
int main()
{
	const char *vertexShaderSource= {
		...
		"	texcoord = vec3(Model * vec4(position.xyz/10+0.5,1.0));\n"
		"}\n"
	};
...
//	glfwWindowHint(GLFW_RESIZABLE,GL_TRUE);
	...
	image = SOIL_load_image("alpha.jpg",&width,&height,0,SOIL_LOAD_RGBA);
	...
	*/
	...
	do
	{
		...
		*/
		...
		glm::mat4 View = glm::lookAt(glm::vec3(0.0f,0.1f,10.0f),glm::vec3(0.0f,0.0f,0.0f),glm::vec3(0.0f,0.0f,1.0f));
		glm::mat4 Model = glm::mat4(1.0f);
		Model = glm::rotate(Model,i,glm::vec3(0.0f,0.0f,1.0f));
